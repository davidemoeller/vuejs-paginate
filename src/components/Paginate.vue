<template>
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    <li v-if="!(firstPageSelected() && hidePrevNext)" :class="[prevClass, firstPageSelected() ? disabledClass : '']">
      <a @click.prevent="prevPage()" @keyup.enter="prevPage()" :href="prevHref" :class="prevLinkClass" :tabindex="firstPageSelected() ? -1 : 0" v-html="prevText"></a>
    </li>
    ...
    <li v-if="!(lastPageSelected() && hidePrevNext)" :class="[nextClass, lastPageSelected() ? disabledClass : '']">
      <a @click.prevent="nextPage()" @keyup.enter="nextPage()" :href="nextHref" :class="nextLinkClass" :tabindex="lastPageSelected() ? -1 : 0" v-html="nextText"></a>
    </li>
  ...
  <div :class="containerClass" v-else>
    ...
    <a v-if="!(firstPageSelected() && hidePrevNext)" @click.prevent="prevPage()" @keyup.enter="prevPage()" :href="prevHref" :class="[prevLinkClass, firstPageSelected() ? disabledClass : '']" tabindex="0" v-html="prevText"></a>
    ...
    <a v-if="!(lastPageSelected() && hidePrevNext)" @click.prevent="nextPage()" @keyup.enter="nextPage()" :href="nextHref" :class="[nextLinkClass, lastPageSelected() ? disabledClass : '']" tabindex="0" v-html="nextText"></a>
